...
const appCss = "/gym-buddy/assets/styles-vxonZNwO.css";
...
class __PRIVATE_QueryImpl {
  ...
  constructor(e, t = null, n = [], r2 = [], i = null, s = "F", o = null, _ = null) {
    this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r2, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = _, this.Ee = null, // The corresponding `Target` of this `Query` instance, for use with
...
function __PRIVATE_queryNormalizedOrderBy(e) {
  ...
  if (null === t.Ee) {
    ...
    r2.forEach(((r3) => {
      e2.has(r3.canonicalString()) || r3.isKeyField() || t.Ee.push(new OrderBy(r3, n));
...
class BloomFilter {
  ...
  ye(e, t, n) {
    ...
    return 1 === r2.compare(dt) && (r2 = new Integer([r2.getBits(0), r2.getBits(1)], 0)), r2.modulo(this.pe).toNumber();
  }
...
class __PRIVATE_WatchChangeAggregator {
  ...
  Tt(e) {
    ...
    this.ze.forEach(((n2, r3) => {
      ...
      if (i) {
        if (n2.current && __PRIVATE_targetIsDocumentTarget(i.target)) {
          ...
          this.Et(t2).has(r3) || this.It(r3, t2) || this.et(r3, t2, MutableDocument.newNoDocument(t2, e));
        }
    ...
    const r2 = new RemoteEvent(e, t, this.Ze, this.je, n);
    return this.je = __PRIVATE_mutableDocumentMap(), this.Je = __PRIVATE_documentTargetMap(), this.He = __PRIVATE_documentTargetMap(), this.Ze = new SortedMap(__PRIVATE_primitiveComparator), r2;
  }
  /**
...
class __PRIVATE_ReferenceSet {
  ...
  Gr(e) {
    ...
    return this.Kr.forEachInRange([n, r2], ((e2) => {
...
class __PRIVATE_MemoryPersistence {
  ...
  runTransaction(e, t, n) {
    ...
    return this.referenceDelegate.Ti(), n(r2).next(((e2) => this.referenceDelegate.Ei(r2).next((() => e2)))).toPromise().then(((e2) => (r2.raiseOnCommittedEvent(), e2)));
  }
  Ii(e, t) {
...
class __PRIVATE_LocalViewChanges {
  constructor(e, t, n, r2) {
    this.targetId = e, this.fromCache = t, this.Ts = n, this.Es = r2;
  }
  static Is(e, t) {
...
function __PRIVATE_localStoreApplyRemoteEventToLocalCache(e, t) {
  ...
  return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e2) => {
    ...
    o.push(__PRIVATE_populateDocumentChangeBuffer(e2, s, t.documentUpdates).next(((e3) => {
      ...
      const t2 = n.li.getLastRemoteSnapshotVersion(e2).next(((t3) => n.li.setTargetsMetadata(e2, e2.currentSequenceNumber, r2)));
      o.push(t2);
    }
...
function __PRIVATE_populateDocumentChangeBuffer(e, t, n) {
  ...
  return n.forEach(((e2) => r2 = r2.add(e2))), t.getEntries(e, r2).next(((e2) => {
    ...
    return n.forEach(((n2, s) => {
      ...
      ) : !o.isValidDocument() || s.version.compareTo(o.version) > 0 || 0 === s.version.compareTo(o.version) && o.hasPendingWrites ? (t.addEntry(s), r3 = r3.insert(n2, s)) : __PRIVATE_logDebug(Nt, "Ignoring outdated watch update for ", n2, ". Current version:", o.version, " Watch version:", s.version);
    })), {
      Bs: r3,
      Ls: i
    };
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", ((e2) => {
    ...
    ) : n.li.allocateTargetId(e2).next(((i2) => (r2 = new TargetData(t, i2, "TargetPurposeListen", e2.currentSequenceNumber), n.li.addTargetData(e2, r2).next((() => r2)))))));
  })).then(((e2) => {
    const r2 = n.vs.get(e2.targetId);
    return (null === r2 || e2.snapshotVersion.compareTo(r2.snapshotVersion) > 0) && (n.vs = n.vs.insert(e2.targetId, e2), n.Fs.set(t, e2.targetId)), e2;
  }));
}
async function __PRIVATE_localStoreReleaseTarget(e, t, n) {
  const r2 = __PRIVATE_debugCast(e), i = r2.vs.get(t), s = n ? "readwrite" : "readwrite-primary";
  try {
  ...
  r2.vs = r2.vs.remove(t), r2.Fs.delete(i.target);
}
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r2.persistence.runTransaction(
    ...
    ((e2) => (function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      const r3 = __PRIVATE_debugCast(e3), i2 = r3.Fs.get(n2);
      return void 0 !== i2 ? PersistencePromise.resolve(r3.vs.get(i2)) : r3.li.getTargetData(t2, n2);
    })(r2, e2, __PRIVATE_queryToTarget(t)).next(((t2) => {
      if (t2) return i = t2.lastLimboFreeSnapshotVersion, r2.li.getMatchingKeysForTargetId(e2, t2.targetId).next(((e3) => {
        s = e3;
      }));
    })).next((() => r2.Cs.getDocumentsMatchingQuery(e2, t, n ? i : SnapshotVersion.min(), n ? s : __PRIVATE_documentKeySet()))).next(((e3) => (__PRIVATE_setMaxReadTime(r2, __PRIVATE_queryCollectionGroup(t), e3), {
      documents: e3,
      ks: s
    }))))
  );
...
function __PRIVATE_setMaxReadTime(e, t, n) {
  let r2 = e.Ms.get(t) || SnapshotVersion.min();
  n.forEach(((e2, t2) => {
...
class __PRIVATE_RestConnection {
  ...
  constructor(e) {
    ...
    this.Ko = t + "://" + e.host, this.Uo = `projects/${n}/databases/${r2}`, this.$o = this.databaseId.database === it ? `project_id=${n}` : `project_id=${n}&database_id=${r2}`;
  }
  Wo(e, t, n, r2, i) {
...
class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
  ...
  T_(e, t, n) {
    const r2 = __PRIVATE_generateUniqueDebugId(), i = [this.Ko, "/", "google.firestore.v1.Firestore", "/", e, "/channel"], s = this.createWebChannelTransport(), o = {
    ...
    return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
      ...
      l || (l = true, __PRIVATE_logDebug(Gt, `RPC '${e}' stream ${r2} transport closed`), h.o_(), this.I_(u));
...
class __PRIVATE_ExponentialBackoff {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    this.Ci = e, this.timerId = t, this.R_ = n, this.A_ = r2, this.V_ = i, this.d_ = 0, this.m_ = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  p_(e) {
    ...
    r2 > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r2} ms (base delay: ${this.d_} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.m_ = this.Ci.enqueueAfterDelay(this.timerId, r2, (() => (this.f_ = Date.now(), e()))), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
class __PRIVATE_RemoteStoreImpl {
  constructor(e, t, n, r2, i) {
    ...
    })), this.Va = new __PRIVATE_OnlineStateTracker(n, r2);
  }
}
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.Ea.delete(t), r2.O_() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.Ea.size && (r2.O_() ? r2.L_() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
    ...
    try {
      await (async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r2 of t2.targetIds)
          e2.Ea.has(r2) && (await e2.remoteSyncer.rejectListen(r2, n2), e2.Ea.delete(r2), e2.da.removeTarget(r2));
      })(e, t);
    } catch (n2) {
    ...
    await (function __PRIVATE_raiseWatchSnapshot(e2, t3) {
      ...
      return n2.targetChanges.forEach(((n3, r2) => {
        if (n3.resumeToken.approximateByteSize() > 0) {
          const i = e2.Ea.get(r2);
          i && e2.Ea.set(r2, i.withResumeToken(n3.resumeToken, t3));
        }
      })), // Re-establish listens for the targets that have been invalidated by
      // existence filter mismatches.
      n2.targetMismatches.forEach(((t4, n3) => {
        const r2 = e2.Ea.get(t4);
        if (!r2)
          return;
        e2.Ea.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
class __PRIVATE_View {
  ...
  ru(e, t) {
    ...
    if (e.inorderTraversal(((e2, t2) => {
      const u = r2.get(e2), c = __PRIVATE_queryMatches(this.query, t2) ? t2 : null, l = !!u && this.mutatedKeys.has(u.key), h = !!c && (c.hasLocalMutations || // We only consider committed mutations for documents that were
  ...
  applyChanges(e, t, n, r2) {
    ...
    const o = t && !r2 ? this._u() : [], _ = 0 === this.Ya.size && this.current && !r2 ? 1 : 0, a = _ !== this.Xa;
...
class __PRIVATE_SyncEngineImpl {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Pu = {}, this.Tu = new ObjectMap(((e2) => __PRIVATE_canonifyQuery(e2)), __PRIVATE_queryEquals), this.Eu = /* @__PURE__ */ new Map(), /**
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  ...
  const s = await __PRIVATE_localStoreExecuteQuery(
    ...
    /* usePreviousResults= */
    true
  ), o = new __PRIVATE_View(t, s.ks), _ = o.ru(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r2 && "Offline" !== e.onlineState, i), u = o.applyChanges(
    _,
    /* limboResolutionEnabled= */
    e.isPrimaryClient,
    a
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  const r2 = __PRIVATE_debugCast(e), i = r2.Tu.get(t), s = r2.Eu.get(i.targetId);
  if (s.length > 1) return r2.Eu.set(i.targetId, s.filter(((e2) => !__PRIVATE_queryEquals(e2, t)))), void r2.Tu.delete(t);
...
async function __PRIVATE_triggerRemoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.Tu.get(t), i = n.Eu.get(r2.targetId);
...
async function __PRIVATE_syncEngineWrite(e, t, n) {
  ...
  try {
    ...
    r2.sharedClientState.addPendingMutation(e2.batchId), (function __PRIVATE_addMutationCallback(e3, t2, n2) {
      ...
      r3 = r3.insert(t2, n2), e3.du[e3.currentUser.toKey()] = r3;
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    r2.Ru = r2.Ru.remove(s), r2.Au.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
...
function __PRIVATE_processUserCallback(e, t, n) {
  ...
  if (i) {
    const e2 = i.get(t);
    e2 && (n ? e2.reject(n) : e2.resolve(), i = i.remove(t)), r2.du[r2.currentUser.toKey()] = i;
  }
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  e.sharedClientState.removeLocalQueryTarget(t);
  for (const r2 of e.Eu.get(t)) e.Tu.delete(r2), n && e.Pu.yu(r2, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n) if (r2 instanceof __PRIVATE_AddedLimboDocument) e.Vu.addReference(r2.key, t), __PRIVATE_trackLimboChange(e, r2);
  else if (r2 instanceof __PRIVATE_RemovedLimboDocument) {
    __PRIVATE_logDebug(Zt, "Document no longer in limbo: " + r2.key), e.Vu.removeReference(r2.key, t);
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.Ru.get(n) || e.Iu.has(r2) || (__PRIVATE_logDebug(Zt, "New document in limbo: " + n), e.Iu.add(r2), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.Iu.size > 0 && e.Ru.size < e.maxConcurrentLimboResolutions; ) {
    ...
    e.Au.set(r2, new LimboResolution(n)), e.Ru = e.Ru.insert(n, r2), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r2, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence.ce));
  }
}
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r2, i, s) {
  const o = e.I(1, t, n), _ = [__PRIVATE_fieldPathFromArgument(t, r2, n)], a = [i];
...
function __PRIVATE_parseData(e, t) {
  ...
  if (
    ...
    return (function __PRIVATE_parseArray(e2, t2) {
      ...
      let r2 = 0;
      for (const i of e2) {
        let e3 = __PRIVATE_parseData(i, t2.gc(r2));
  ...
  return (function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r2.isEqual(n)) throw t2.yc(`Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`);
      return {
...
function __PRIVATE_parseObject(e, t) {
  ...
  return isEmpty(e) ? (
    ...
    const i = __PRIVATE_parseData(r2, t.dc(e2));
    null != i && (n[e2] = i);
  })), {
    mapValue: {
      fields: n
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (!__PRIVATE_looksLikeJsonObject(n) || !__PRIVATE_isPlainObject(n)) {
    ...
    throw "an object" === r2 ? t.yc(e + " a custom object") : t.yc(e + " " + r2);
  }
}
...
function getDocs(t) {
  ...
  const e = __PRIVATE_cast(t.firestore, Firestore), n = ensureFirestoreConfigured(e), r2 = new __PRIVATE_ExpUserDataWriter(e);
  return __PRIVATE_validateHasExplicitOrderByForLimitToLast(t._query), __PRIVATE_firestoreClientGetDocumentsViaSnapshotListener(n, t._query).then(((n2) => new QuerySnapshot(e, r2, t, n2)));
}
...
function updateDoc(t, e, n, ...r2) {
  ...
  (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(o, "updateDoc", t._key, e, n, r2) : __PRIVATE_parseUpdateData(o, "updateDoc", t._key, e);
...
function addDoc(t, e) {
  const n = __PRIVATE_cast(t.firestore, Firestore), r2 = doc(t), s = __PRIVATE_applyFirestoreDataConverter(t.converter, e), o = __PRIVATE_newUserDataReader(t.firestore);
  return executeWrite(n, [__PRIVATE_parseSetData(o, "addDoc", r2._key, s, null !== t.converter, {}).toMutation(r2._key, Precondition.exists(false))]).then((() => r2));
}
...
function __PRIVATE_convertToDocSnapshot(t, e, n) {
  const r2 = n.docs.get(e._key), s = new __PRIVATE_ExpUserDataWriter(t);
  return new DocumentSnapshot(t, s, e._key, r2, new SnapshotMetadata(n.hasPendingWrites, n.fromCache), e.converter);
}
...
const firebaseConfig = {
  ...
  databaseURL: "https://fittracker-fee91-default-rtdb.europe-west1.firebasedatabase.app",
...
const Dumbbell = createLucideIcon("dumbbell", __iconNode$3);
...
function AuthGate({ children }) {
  ...
  reactExports.useEffect(() => subscribeAuth(setUser), [setUser]);
  reactExports.useEffect(() => {
    if (loading) return;
    const isPublic = PUBLIC.includes(location2.pathname);
    if (!user && !isPublic) navigate({ to: "/login" });
    if (user && isPublic) navigate({ to: "/" });
  }, [user, loading, location2.pathname, navigate]);
  if (loading) {
...
function AppHeader() {
  ...
  if (!user) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "border-b bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-3xl items-center justify-between px-4 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-semibold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dumbbell, { className: "h-5 w-5 text-primary" }),
        "FitTracker"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "outline", size: "sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/workouts/area", className: "flex items-center gap-2", children: [
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthGate, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppHeader, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, {})
  ] }) });
}
const $$splitComponentImporter$6 = () => import("./signup-2qOCBLMJ.js");
const Route$6 = createFileRoute("/signup")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./login-Bu29rcnj.js");
const Route$5 = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./index-BlcvaZ1W.js");
const Route$4 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./workouts.new-_Pd9eqK0.js");
const Route$3 = createFileRoute("/workouts/new")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./workouts.area-Jk5SaToR.js");
const Route$2 = createFileRoute("/workouts/area")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./workouts._workoutId-a3HW0ekD.js");
const Route$1 = createFileRoute("/workouts/$workoutId")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./workouts.-B28XfeLb.js");
const Route2 = createFileRoute("/workouts/")({
...
const WorkoutsNewRoute = Route$3.update({
  id: "/workouts/new",
  path: "/workouts/new",
  getParentRoute: () => Route$7
});
const WorkoutsAreaRoute = Route$2.update({
  id: "/workouts/area",
  path: "/workouts/area",
  getParentRoute: () => Route$7
});
const WorkoutsWorkoutIdRoute = Route$1.update({
  id: "/workouts/$workoutId",
  path: "/workouts/$workoutId",
  getParentRoute: () => Route$7
});
const WorkoutsRoute = Route2.update({
  id: "/workouts/",
  path: "/workouts/",
  getParentRoute: () => Route$7
});
...
const history = typeof window !== "undefined" ? createHashHistory({ window }) : createMemoryHistory();
