...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DhWUx-T-.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Du8WslyJ.js").then((n2) => n2.y),
...
var ROUTER_BASEPATH = "gym-buddy";
var SERVER_FN_BASE = "/gym-buddy/_serverFn/";
...
export {
  ...
  React$1 as _,
  arraysEqual as a,
  createHashHistory as a0,
  createMemoryHistory as a1,
